 ...
 <head>
     ...
     <title>Dashboard - Orçamento</title>
 ...
 <body>
     <div id="dashboard" class="dashboard">
         <header class="dashboard-header">
             <h1><i class="fas fa-file-invoice-dollar"></i>Orçamento</h1>
         ...
         <main class="dashboard-content">
             <div class="section-header">
                 ...
                 <div class="header-buttons">
                     <button id="novoItemBtn" class="novo-item-btn">
                                     ...
                                     <div class="menu">
                                         ...
                                         <div class="info form-row">
                                             ...
                                             <div class="form-group"><label for="OrcDescricao">Tipo:</label><input
                                                     type="text" id="OrcTipo"
                                                     value="<?php echo htmlspecialchars($row['OrcTipo'] ?? 'Não informado'); ?>"
                                                     disabled></div>
                                             <div class="form-group"><label for="OrcDescricao">Preço:</label><input
                                                     type="text" id="OrcPreco"
                                                     value="<?php echo htmlspecialchars($row['OrcPreco'] ?? 'Não informado'); ?>"
                                                     disabled></div>
                                         </div>
                                         ...
                                         <div class="info form-row">
                                             <div class="form-group"><label for="OrcDescricao">Email:</label><input
                                                     type="text" id="CliEmail"
                                                     value="<?php echo htmlspecialchars($row['CliEmail'] ?? 'Não informado'); ?>"
                                                     disabled></div>
                                         </div>
                                         <div class="info form-row">
                                             <div class="form-group"><label for="OrcDescricao">Endereço:</label><input
                                                     type="text" id="CliEndereco"
                                                     value="<?php echo htmlspecialchars($row['CliEndereco'] ?? 'Não informado'); ?>"
                                                     disabled></div>
                                             <div class="form-group"><label for="OrcDescricao">Cidade:</label><input
                                                     type="text" id="CliCidade"
